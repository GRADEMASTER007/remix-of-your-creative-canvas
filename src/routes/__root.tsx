  ...
  head: () => ({
    meta: [
      ...
      { title: "Living Culture Health — Africa's Heritage Marketplace" },
      {
        name: "description",
        content:
          "Shop African foods, baking, traditional medicinals and art from heritage sellers across the continent.",
      },
      { name: "author", content: "Living Culture Health" },
      { property: "og:title", content: "Living Culture Health — Africa's Heritage Marketplace" },
      {
